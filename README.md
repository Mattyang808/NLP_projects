...
- **Disentangled Attention:** Content-to-position ($c \to p$) interactions were found to be more useful than position-to-content ($p \to c$) for NLI reasoning.
...
- **Jianyun Yang (24181422):** Project 1 Lead; Project 2 Model C design, implementation, and qualitative study.
